...
public class DashboardController : Controller
{
    ...
    public async Task<IActionResult> Index(string town, string risk)
    {
        ...
        {
            InspectionsThisMonth = await inspections.CountAsync(i => i.InspectionDate.Month == now.Month),
            FailedInspectionsThisMonth = await inspections.CountAsync(i => i.Outcome == "Fail"),
